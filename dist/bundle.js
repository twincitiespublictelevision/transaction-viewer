...
function loadProfile(dispatch, getState) {
  return axios.get("".concat(getState().config.endpoints.profile)).then(function (response) {
    var settings = {
...
function updateProfile$1(toStore) {
  return function (dispatch, getState) {
    return axios.patch("".concat(this.props.config.endpoints.profile), toStore).then(function (response) {
      dispatch({
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    loadFields: function loadFields$$1() {
      return loadFields(dispatch);
    },
    fetchData: function fetchData$$1() {
      return fetchData(wpNonce)(dispatch, store.getState);
    },
    ...
    setStartDate: function setStartDate$$1(startDate) {
      setStartDate(wpNonce)(startDate)(dispatch, store.getState);
    },
    setEndDate: function setEndDate$$1(endDate) {
      setEndDate(wpNonce)(endDate)(dispatch, store.getState);
    },
    removeEndDate: function removeEndDate$$1() {
      removeEndDate(wpNonce)(dispatch, store.getState);
    },
...
var TransactionTotals$1 = connector(TransactionTotals);
...
function (_Component) {
  ...
  _createClass(TransactionReport, [{
    ...
    value: function render() {
      ...
      }, React.createElement("h3", null, "Date Range"), React.createElement(DateManager$1, null), React.createElement("h3", null, "Time Range"), React.createElement(TimeRangePicker$1, null)), React.createElement("div", {
        className: "transaction-summary"
      }, React.createElement("h3", null, "Unfiltered Summary"), React.createElement(TransactionTotals$1, null)), React.createElement("div", {
        className: "transaction-field-filters"
      }, React.createElement("h3", null, "Filters"), React.createElement(FilterManager$1, null))), React.createElement("h3", null, "Records"), React.createElement(TransactionTable$1, {
        data: data
  ...
  _createClass(TransactionViewer, [{
    ...
    value: function render() {
      return React.createElement(Provider, {
        store: store
      }, React.createElement(TransactionReport$1, null));
    }
  }]);
